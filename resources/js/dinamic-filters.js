function createSearchRow(count) {
    return `<div class="search-row d-flex gap-2 align-items-center mb-2">
        <input type="text" class="form-control" name="search[${count}][term]" placeholder="Search term...">
        <input type="number" class="form-control w-25" name="search[${count}][within]" placeholder="Within n chars from last word">
