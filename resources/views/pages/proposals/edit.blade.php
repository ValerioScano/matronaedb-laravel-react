    ...
    <form action="{{ route('proposals.update', $proposal) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row align-items-center gx-5 p-4 border border-primary-subtle border-opacity-25 rounded-4">
            ...
            <div class="col-12 my-3">
                <label for="text" class="form-label">Add inscription's text <span class="text-danger">*</span></label> <a data-bs-toggle="offcanvas" href="#offcanvas" role="button"
                    aria-controls="offcanvas"><i class="bi bi-info-circle"></i></a>
                <textarea name="text" class="form-control @error('text') is-invalid @enderror" style="height:auto" id="text"
                    aria-describedby="text-help" required>{{ $proposal->text }}</textarea>
                </div>
                @error('text')
            ...
            <div class="col-12 col-md-4 mb-3">
                ...
                <input name="macroarea" type="text" class="form-control @error('macroarea') is-invalid @enderror"
                    ...
                    value="{{ old('macroarea', $proposal->macroarea) }}">
            ...
            <div class="col-12 col-md-4 mb-3">
                ...
                <input name="province" type="text" class="form-control @error('province') is-invalid @enderror"
                    id="province" required list="province-suggestions" value="{{ old('province', $proposal->province) }}">
            ...
            <div class="col-12 col-md-4 mb-3">
                ...
                <input name="min_year" type="number" class="form-control" id="min_year" min="-750" max="1800"
                    value="{{ old('min_year', $proposal->min_year) }}">
            </div>
            ...
            <div class="col-12 col-md-4 mb-3">
                ...
                <input name="max_year" type="number" class="form-control" id="max_year" min="-750" max="1800"
                    value="{{ old('max_year', $proposal->max_year) }}">
            </div>
            ...
            <div class="col-12 col-md-4 mb-3 form-check">
                <input name="is_certain_date" type="checkbox" class="form-check-input" id="is_certain_date"
                    @checked(old('is_certain_date', $proposal->is_certain_date))>
            ...
            <div class="col-12 col-md-6 mb-3 form-check">
                <input name="is_sacred_dedication" type="checkbox" class="form-check-input" id="is_sacred_dedication"
                    @checked(old('is_sacred_dedication', $proposal->is_sacred_dedication))>
            ...
            <div class="col-12 col-md-6 mb-3">
                ...
                <select name="religion" class="form-select @error('religion') is-invalid @enderror" id="religion">
                    <option value="uncertain" @selected(old('religion', $proposal->religion) === 'uncertain')>Uncertain</option>
                    <option value="pagan" @selected(old('religion', $proposal->religion) === 'pagan')>Pagan</option>
                    <option value="christian" @selected(old('religion', $proposal->religion) === 'christian')>Christian</option>
                </select>
                @error('religion')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            ...
            <div class="col-12 mb-3">
                <label for="notes" class="form-label">Do you want to add a public comment on this
                    inscription?</label>
                <textarea name="notes" class="form-control" id="notes" aria-describedby="notes-help">{{ old('notes', $proposal->notes) }}</textarea>
            ...
            <div class="col-12 mb-3">
                <label for="private_notes" class="form-label">Is there anything that the admin should
                    know?</label>
                <textarea name="private_notes" id="private_notes" class="form-control">{{ old('private_notes', $proposal->private_notes) }}</textarea>
            </div>
        </div>
        ...
        @php
            $editionsSource = old('editions', $proposal->editions->toArray());
        ...
        <div class="row align-items-center gx-5 my-2 p-4 border border-primary-subtle border-opacity-25 rounded-4">
            <h4>People</h4>
            <div class="col-12 my-3">
                <div id="people-container" data-people='@json(old('people', $proposal->people->toArray()))'>
        ...
        <div class="row align-items-center gx-5 my-2 p-4 border border-primary-subtle border-opacity-25 rounded-4">
            ...
            <div class="col-12 my-3">
                <div id="external-resources-container" data-external-resources='@json(old('external_resources', $proposal->externalResources->toArray()))'>
                                    ...
                                    <td class="ps-0 py-1">
                                        <div class="form-check mb-0">
                                            <input type="checkbox" class="form-check-input"
                                                ...
                                                value="{{ $pair['base']->id }}" @checked(in_array($pair['base']->id, old('tags', $proposal->tags->pluck('id')->toArray())))>
                                        ...
                                        @if ($pair['uncertain'])
                                            <div class="form-check mb-0">
                                                <input type="checkbox" class="form-check-input"
                                                    ...
                                                    value="{{ $pair['uncertain']->id }}" @checked(in_array($pair['uncertain']->id, old('tags', $proposal->tags->pluck('id')->toArray())))>
                                                <label class="form-check-label"
