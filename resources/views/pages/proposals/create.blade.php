        ...
        <form action="{{ route('proposals.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row align-items-center gx-5 p-4 border border-primary-subtle border-opacity-25 rounded-4">
                ...
                <div class="col-12 my-3">
                    ...
                    <textarea name="text" class="form-control" style="height:auto" id="text" aria-describedby="text-help" required>{{ old('text') }}</textarea>
                ...
                <div class="col-12 col-md-4 mb-3">
                    ...
                    <input name="min_year" type="number" class="form-control" id="min_year" value="{{ old('min_year') }}">
                </div>

                <div class="col-12 col-md-4 mb-3">
                    <label for="max_year" class="form-label">Latest datation</label>
                    <input name="max_year" type="number" class="form-control" id="max_year" value="{{ old('max_year') }}">
                </div>
            ...
            <div class="row align-items-center gx-5 my-2 p-4 border border-primary-subtle border-opacity-25 rounded-4">
                ...
                <div class="col-12 my-3">
                    <div id="external-resources-container" data-external-resources='[]'>
