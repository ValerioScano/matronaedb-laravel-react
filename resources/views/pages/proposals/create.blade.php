    ...
    <form action="{{ route('proposals.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row align-items-center gx-5 p-4 border border-primary-subtle border-opacity-25 rounded-4">
            ...
            <div class="col-12 my-3">
                ...
                <textarea name="text" class="form-control @error('text') is-invalid @enderror" style="height:auto" id="text"
                    aria-describedby="text-help" required>{{ old('text') }}</textarea>
            </div>
            @error('text')
        ...
        <div class="col-12 col-md-4 mb-3">
            ...
            <input name="macroarea" type="text" class="form-control @error('macroarea') is-invalid @enderror"
                id="macroarea" required autocomplete="off" list="macroarea-suggestions" value="{{ old('macroarea') }}">
        ...
        <div class="col-12 col-md-4 mb-3">
            ...
            <input name="province" type="text" class="form-control @error('province') is-invalid @enderror"
                id="province" required list="province-suggestions" value="{{ old('province') }}">
        ...
        <div class="col-12 col-md-6 mb-3 form-check">
            <input name="is_sacred_dedication" type="checkbox" class="form-check-input" id="is_sacred_dedication"
                @checked(old('is_sacred_dedication'))>
        ...
        <div class="col-12 col-md-6 mb-3">
            ...
            <select name="religion" class="form-select @error('religion') is-invalid @enderror" id="religion">
                <option value="uncertain" @selected(old('religion') === 'uncertain')>Uncertain</option>
                <option value="pagan" @selected(old('religion') === 'pagan')>Pagan</option>
        ...
        <div class="col-12 mb-3">
            <label for="notes" class="form-label">Do you want to add a public comment on this
                inscription?</label>
            <textarea name="notes" class="form-control" id="notes" aria-describedby="notes-help">{{ old('notes') }}</textarea>
        ...
        <div class="row align-items-center gx-5 my-2 p-4 border border-primary-subtle border-opacity-25 rounded-4">
            <h4>People</h4>
            <div class="col-12 my-3">
                <div id="people-container" data-people='@json(old('people', []))'>
        ...
        <div class="row align-items-center gx-5 my-2 p-4 border border-primary-subtle border-opacity-25 rounded-4">
            ...
            <div class="col-12 my-3">
                <div id="external-resources-container" data-external-resources='@json(old('external_resources', []))'>
                    {{-- Risorse esterne aggiunte qui --}}
                </div>
                                    ...
                                    <td class="ps-0 py-1">
                                        <div class="form-check mb-0">
                                            <input type="checkbox" class="form-check-input"
                                                ...
                                                value="{{ $pair['base']->id }}" @checked(in_array($pair['base']->id, old('tags', [])))>
                                        ...
                                        @if ($pair['uncertain'])
                                            <div class="form-check mb-0">
                                                <input type="checkbox" class="form-check-input"
                                                    ...
                                                    value="{{ $pair['uncertain']->id }}" @checked(in_array($pair['uncertain']->id, old('tags', [])))>
                                                <label class="form-check-label"
